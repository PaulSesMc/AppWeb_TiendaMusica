          ...
          <div class="col-md-12">
            <div class="text-content" >
              ...
              <div class="contact-form">
                <form id="contact" action="exito.php" method="post">
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      <fieldset>
                        <input type="date" name="nacimiento" id="" value="2004-01-01" max="2004-12-31" placeholder="Nacimiento">
                      </fieldset>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-12">
                      <fieldset>
                        <input type="number" name="tarjeta" id="" placeholder="Número de tarjeta">
                      </fieldset>
                    </div>
                    <div class="col-lg-12">
                      <fieldset>
                        <input type="Text" name="direccion" id="" placeholder="Direccion (Calle, Numero)" required="">
                      </fieldset>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12">
                      <fieldset>
                        <button type="submit" id="form-submit" class="filled-button">Registrarse</button>
                      </fieldset>
                    </div>
                  </div>
                </form>
