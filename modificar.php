              ...
              <div class="table-responsive">
                <?php
                  ...
                  while($row = mysqli_fetch_array($productos)) {
                    ...
                    <td><form method=\"POST\"><button name=\"eliminar\" value=\"$id\" type=\"submit\" class=\"eliminar\" onclick=\"borrar($id)\">Eliminar</button></form></td>
                    <td><form method=\"POST\" action=\"agregar.php\"><button name=\"modificar\" value=\"$id\" type=\"submit\" class=\"modificar\">Modificar</button></td></form></tr>";
                  }
                  echo "</table>";
